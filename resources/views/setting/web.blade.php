...
@section('content')
    ...
    <form class="flex flex-col space-y-4" action="{{ route('setting.web') }}" method="post">
        ...
        <div class="mb-5">
            <label for="chief_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                Nama Kepala Dinas
            </label>
        ...
        <div class="mb-5">
            <label for="chief_nip" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                NIP Kepala Dinas
            </label>
