...
@section('content')
    <form class="flex flex-col space-y-4" action="{{ route('assignment.create') }}" method="post">
        ...
        <div class="mb-5">
            <label for="number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Surat
                Tugas</label>
            <input type="text" id="number" name="number"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-green-500 focus:border-green-500 block w-full p-2.5"
        ...
        <div class="mb-5">
            ...
            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Surat Tugas</label>
            <input
